<template>
  <div class="bg-accent min-h-screen font-sans" dir="rtl">
    ...
    <section id="bio" class="relative bg-primary w-full py-20 h-[310px] md:h-[500px] flex items-center overflow-hidden">
      ...
      <div class="relative z-10 container mx-2 px-0 md:px-[24px] lg:px-[60px] flex flex-row md:flex-row items-center justify-between">
        ...
        <p class="text-hardwhite text-right md:text-center text-md md:text-3xl md:leading-relaxed leading-relaxed font-light w-1/2">
          شيف ليبي محترف وصانع محتوى يقدّم نصائح ووصفات يومية.<br> يسعى يجعل الطبخ عادة ممتعة وسهلة.
        </p>
      </div>
    </section>

    <!-- CONTACT SECTION -->
    <section id="contact" class="relative bg-hardwhite w-full py-20 h-[310px] md:h-[500px] flex items-center overflow-hidden" dir="rtl">
      <div class="relative z-10 container mx-auto px-4 md:px-[60px] flex flex-row items-center justify-between">
        <h2 class="text-primary text-center text-[52px] md:text-[92px] font-bold leading-tight whitespace-nowrap w-1/2">
          <span class="relative inline-block">
            تواصل
            <span class="absolute -bottom-1 md:-bottom-2 left-1/2 -translate-x-1/2 w-[40%] h-[4px] md:h-[8px] bg-primary rounded-full"></span>
          </span>
